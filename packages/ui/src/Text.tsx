...
return <div className="pt-2">
    ...
    <input required className="[appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" type="number" id={id} min={1} onChange={(e)=>{onChange(e.target.valueAsNumber||null)}} placeholder={placeholder} 
